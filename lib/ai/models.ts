export const MODELS = {
  ...
  openrouter_free: {
    id: 'openrouter/free',
    description:
      'OpenRouter auto-router. Picks the best free model for your request. Handles tool use, vision, etc.',
  },
  // Opencode Zen Models
  big_pickle: {
    id: 'big-pickle',
  ...
  kimi_2_5: {
    ...
    tier: 'paid',
    description:
      'High-performance model for complex analysis and reasoning tasks.',
  },
} as const;
