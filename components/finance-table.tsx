          ...
          <form
            action={(formData) => {
              startTransition(async () => {
                ...
                await deleteManyEntries(formData, {
                  user: { id: session.user.id },
                });
                const remaining = entries.data.filter(
                ...
                setEntries({
                  ...
                  totalItems: Math.max(
                    0,
                    entries.totalItems - selectedIds.length,
                  ),
                });
                setSelectedIds([]);
              });
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead
              ...
              onKeyDown={(e) =>
                (e.key === 'Enter' || e.key === ' ') && handleSort('fecha')
              }
              role="columnheader"
              tabIndex={0}
            ...
            <TableHead
              ...
              onKeyDown={(e) =>
                (e.key === 'Enter' || e.key === ' ') && handleSort('accion')
              }
              role="columnheader"
              tabIndex={0}
            ...
            <TableHead
              ...
              onKeyDown={(e) =>
                (e.key === 'Enter' || e.key === ' ') && handleSort('que')
              }
              role="columnheader"
              tabIndex={0}
            ...
            <TableHead
              ...
              onKeyDown={(e) =>
                (e.key === 'Enter' || e.key === ' ') && handleSort('tipo')
              }
              role="columnheader"
              tabIndex={0}
            ...
            <TableHead
              ...
              onKeyDown={(e) =>
                (e.key === 'Enter' || e.key === ' ') && handleSort('cantidad')
              }
              role="columnheader"
              tabIndex={0}
            ...
            <TableHead
              ...
              onKeyDown={(e) =>
                (e.key === 'Enter' || e.key === ' ') && handleSort('quien')
              }
              role="columnheader"
              tabIndex={0}
                ...
                >
                  <div className="flex flex-col items-center gap-1">
                    ...
                    {shouldSplitTransaction(
                      ...
                      <span
                        className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-orange-50 text-orange-700/70`}
                      >
                    ...
                    <form
                      action={(formData) => {
                        ...
                        startTransition(async () => {
                          ...
                          const updatedData = currentEntries.data.filter(
