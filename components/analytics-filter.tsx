  ...
  return (
    <div className="flex flex-wrap gap-2 items-end mb-4">
      ...
      <div className="flex gap-1">
        ...
        <Button size="sm" variant="ghost" onClick={setYTD}>
          YTD
        </Button>
        {years.map((y) => (
          <Button key={y} size="sm" variant="ghost" onClick={() => setYear(y)}>
            {y}
          </Button>
        ))}
      </div>
      ...
      <Button
        ...
        onClick={() =>
          onChange({ ...value, useActivePeriods: !value.useActivePeriods })
        }
      >
        {value.useActivePeriods
