      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-destructive">
            {sums.gastos.toLocaleString('es-ES', {
              style: 'currency',
              currency: 'EUR',
            })}
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-green-600">
            {sums.ingresos.toLocaleString('es-ES', {
              style: 'currency',
              currency: 'EUR',
            })}
          </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-blue-600">
            {sums.inversion.toLocaleString('es-ES', {
              style: 'currency',
              currency: 'EUR',
            })}
          </div>
        ...
        <CardContent>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            <div className="flex items-center gap-1 rounded-full px-2 py-1 text-xs bg-muted text-muted-foreground">
              ...
              <span>
                {(monthsInRange > 0
                  ? (metrics?.totalAmount ?? 0) / monthsInRange
                  : 0
                ).toLocaleString('es-ES', {
                  style: 'currency',
                  currency: 'EUR',
            ...
            <div className="flex items-center gap-1 rounded-full px-2 py-1 text-xs bg-muted text-muted-foreground">
              ...
              <span>
                {(yearsInRange > 0
                  ? (metrics?.totalAmount ?? 0) / yearsInRange
                  : 0
                ).toLocaleString('es-ES', {
                  style: 'currency',
                  currency: 'EUR',
