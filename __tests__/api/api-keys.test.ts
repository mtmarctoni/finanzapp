...
>;
const mockedCreateApiKey = createApiKey as jest.MockedFunction<
  typeof createApiKey
>;
const mockedGetApiKeyById = getApiKeyById as jest.MockedFunction<
  typeof getApiKeyById
>;
const mockedListApiKeys = listApiKeys as jest.MockedFunction<
  typeof listApiKeys
>;
const mockedRevokeApiKey = revokeApiKey as jest.MockedFunction<
  typeof revokeApiKey
>;
